...
**Today's Progress**: Worked with the main project, tried to fix the things I thouhgt were caused because annotations were done on windows, but it seems like the problem lies elsewhere.
...
**Today's Progress**: Did another PyBites challenge. Main project is still in training.
...
**Today's Progress**: Di a PyBites challenge with Named Touples. Main project is on 125th iteration.
...
**Today's Progress**: Did a challenge on PyBites platform. Main project is on 144th iteration.
